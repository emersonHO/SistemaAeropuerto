...
public class Cancelar_Pasaje extends javax.swing.JFrame {
    Connection conn;
    PreparedStatement pst;
    ResultSet rs;

    public Cancelar_Pasaje() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Fecha de cancelación:");
        ...
        jLabel1.setText("Cancelar pasaje de vuelo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cancelar_Pasaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cancelar_Pasaje().setVisible(true);
            }
        });
    }
